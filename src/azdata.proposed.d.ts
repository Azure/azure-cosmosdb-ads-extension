...
declare module "azdata" {
   ...
   */
  export interface TabbedPanelComponentBuilder
    extends ContainerBuilder<TabbedPanelComponent, TabbedPanelLayout, any, ComponentProperties> {
    /**
    ...
    withTabs(
      tabs: (Tab | TabGroup)[]
    ): ContainerBuilder<TabbedPanelComponent, TabbedPanelLayout, any, ComponentProperties>;
  }
  ...
  export namespace window {
     ...
     */
    export function createModelViewDashboard(
      title: string,
      name?: string,
      options?: ModelViewDashboardOptions
    ): ModelViewDashboard;
  ...
  export namespace workspace {
     ...
     */
    export function createModelViewEditor(
      title: string,
      options?: ModelViewEditorOptions,
      name?: string
    ): ModelViewEditor;
  }
  ...
  export interface AccountProvider {
    ...
    ): Thenable<{ token: string } | undefined>;
  }
